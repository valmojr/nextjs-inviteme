...
export default function SideMenuButton(
  ...
  const onClickHandler = (
	...
	useEffect(() => {
		if (url === `/dashboard/${label?.toLowerCase()}`) {
			setIsSelected(!isSelected);
		}
	}, [isSelected, url, label])
	return (
    <button
      className={cn(
        ...
        "lg:w-full lg:rounded-lg lg:bg-stone-400",
        props?.className,
        isHovered ? "w-24 bg-blue-500 lg:bg-blue-500" : "",
        isSelected ? "bg-blue-500" : "bg-red-400"
      )}
    ...
    >
      {iconHandler(icon)}
      <h1 className={cn("text-center text-[0px] lg:text-lg", "", "")}>
